...
//    value является дженериком, т.к. к каждому состоянию будет прикреплён свой тип передаваемых данных (например если успешно загрузился список фотографий - то массив с фотографиями или ошибка, тогда передаваться должна ошибка. Используя дженерик можно добиться большей гибкости в передаче состояний
    var value: Generic {
        didSet {
